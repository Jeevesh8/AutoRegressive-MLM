    ...
    with open(args.read_file, 'r') as f:
        ...
        for i, line in enumerate(old_strs):
            ...
            if line.strip()=='' or i==len(old_strs):
                ...
                componenets = get_components(essay_lis)
                new_essay_lis = add_cols(str_lis, componenets, args)
                added_cols_strs += new_essay_lis
                new_essay_lis = []
            
            else:
                essay_lis.append(line)

    with open(args.write_file) as f:
